...
* [Pay Pay4/2まで02時まで](https://qr.paypay.ne.jp/p2p01_gfgo1kA2GR15718o)<br>
...
LINEアプリの <kbd>ホーム</kbd> > <kbd>⚙</kbd> から｢**設定**｣に入り、｢**LINELABを押して**｣右上の｢**LIME**｣のボタンより開けます。また、クローンアプリなどでは LI**M**E 側からしか設定できない場合があるようです。
